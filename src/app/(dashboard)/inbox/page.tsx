...
import type { InboxFilter, AssignmentFilter } from "@/components/inbox/conversation-list";
...
function InboxPageInner() {
  ...
  return (
    <div className="-m-4 flex h-[calc(100vh-3.5rem)] flex-col overflow-hidden sm:-m-6 lg:h-[calc(100vh-3rem)]">
      {/* Title for Desktop */}
      <div className="hidden shrink-0 border-b border-border bg-background px-6 py-4 lg:block">
      ...
      <div className="flex flex-1 overflow-hidden">
        {/* New Inbox Filters Sidebar (Desktop only) */}
        <div 
          className={cn(
            "hidden flex-col border-r border-border bg-card transition-[width] duration-200 ease-out lg:flex shrink-0",
            inboxSidebarOpen ? "w-56" : "w-14 items-center"
          )}
        >
           <InboxSidebar 
             filter={filter} 
             ...
             isCollapsed={!inboxSidebarOpen}
             onToggle={() => setInboxSidebarOpen(o => !o)} 
           />
        </div>
