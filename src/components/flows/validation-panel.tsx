...
import { CircleAlert, CircleCheck, ChevronUp, ChevronDown } from "lucide-react";
...
export function ValidationPanel() {
  ...
  return (
    ...
    >
      <div 
        className="mb-2 flex items-center gap-2 text-xs text-muted-foreground cursor-pointer select-none"
      ...
      >
        ...
        <span className="flex-1 font-medium">{t("summary", { errorCount: errors.length, warningCount: warnings.length })}</span>
