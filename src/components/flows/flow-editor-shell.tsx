...
const FlowBuilder = dynamic(() => import("./flow-builder").then(m => m.FlowBuilder), {
  ssr: false,
  loading: () => <div className="flex h-full items-center justify-center p-8"><span className="loader" /></div>,
});
