...
export interface Contact {
  ...
  tags?: Tag[];
  /** Hydrated by queries that embed `deals(*, stage:pipeline_stages(*))`. */
  deals?: (Deal & { stage?: PipelineStage | null })[];
}
...
export interface Conversation {
  ...
  /** True when the AI transferred the conversation and requires human attention (migration 047). */
...
export interface Message {
  ...
  /**
   * True when this message is an internal staff note or an automated AI handoff note.
   * Internal notes are strictly hidden from the customer and never sent to external WhatsApp providers.
   */
  is_internal?: boolean;
}
