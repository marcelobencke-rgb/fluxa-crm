...
describe('parseGeneration', () => {
  ...
  it('detects natural language handoff expressions', () => {
    expect(parseGeneration({ text: 'Claro! Vou chamar um especialista da equipe.', usage: null })).toEqual({
      text: 'Claro! Vou chamar um especialista da equipe.',
      handoff: true,
      usage: null,
      tool_calls: undefined,
    })
