...
import { TriggerPanel, NodeConfigWithAdvanced } from './flow-builder';
    ...
    <>
      <div className="h-full w-full overflow-hidden">
        ...
        >
          ...
          />
          <Panel position="top-left" className="!top-4 !left-4 flex flex-col gap-3 w-[268px]">
            <div>
              <CanvasAddNodeButton t={t} />
            </div>
            <TriggerPanel
      ...
      <NodeEditSheet
        ...
        onUpdateNode={(patch) => selectedNodeKey && updateNode(selectedNodeKey, patch)}
...
function NodeEditSheet({
  ...
  onClose: () => void;
  onUpdateNode: (patch: Partial<BuilderNode>) => void;
