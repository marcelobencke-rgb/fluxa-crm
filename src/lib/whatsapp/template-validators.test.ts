...
describe('validateFooter', () => {
  ...
  it('rejects variables in footer', () => {
    expect(() => validateFooter('Powered by {{1}}')).toThrow(/variáveis/);
  });
});
...
describe('validateButtons', () => {
  ...
  it('rejects > 10 buttons', () => {
    ...
    expect(() => validateButtons(tooMany)).toThrow(/10 botões/);
  });
