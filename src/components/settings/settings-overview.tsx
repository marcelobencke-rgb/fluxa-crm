...
export function SettingsOverview({
  ...
  const { config: waConfig, health: waHealth, loading: whatsappLoading } = useWhatsAppConfig();
  const whatsapp = waConfig ? {
    configured: waConfig.provider === 'evolution' ? !!waConfig.evolution_instance_id : !!waConfig.phone_number_id,
    connected: waHealth.connected
  } : null;
